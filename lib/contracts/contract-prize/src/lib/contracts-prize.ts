...
const GetManyAchievedPrizeContract =
  API
    .Post
    .Path('/prizes/achieved')
    .Body<{ collectedPoints: number }>()
    .Returns<PrizeResponseItem[]>();

export type GetManyAchievedPrizeBodyParams = typeof GetManyAchievedPrizeContract.bodyParams;
export type GetManyAchievedPrizeResult = typeof GetManyAchievedPrizeContract.result;

const GetOneNextPrizeContract =
  API
    .Post
    .Path('/prizes/next-available')
    .Body<{
      collectedPoints: number;
    }>()
    .Returns<PrizeResponseItem | null>();

export type GetOneNextPrizeBodyParams = typeof GetOneNextPrizeContract.bodyParams;
